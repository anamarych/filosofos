...
void init_tmr1(void)
{
    ...
    /* One interrupt each 10 ms if Fcy = Fosc/2 = 39.6288 MHz */
    PR1 = 1548; 
...
unsigned int task_code_address;
...
int create_task(unsigned int code_address, 
                ...
                unsigned int priority)
{
    ...
    task_code_address = code_address;
